...
$(call inherit-product-if-exists, vendor/zte/pine/pine-vendor.mk)
...
# Fingerprint
PRODUCT_PACKAGES += \
    android.hardware.biometrics.fingerprint@2.1-service.pine

# Fingerprint On(Under) Display
PRODUCT_PACKAGES += \
    vendor.mokee.biometrics.fingerprint.inscreen@1.0-service.zte_pine
