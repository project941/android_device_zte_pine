...
patchelf --remove-needed android.hidl.base@1.0.so \
        "${MK_ROOT}/vendor/${VENDOR}/${DEVICE}/proprietary/lib64/liblocationservice_jni.so"
patchelf --remove-needed android.hidl.base@1.0.so \
        "${MK_ROOT}/vendor/${VENDOR}/${DEVICE}/proprietary/lib64/libxt_native.so"

sed -i 's/<library name="android.hidl.manager-V1.0-java"/<library name="android.hidl.manager@1.0-java"/g' \
        "${MK_ROOT}/vendor/${VENDOR}/${DEVICE}/proprietary/etc/permissions/qti_libpermissions.xml"
